...
export function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Open email client
    window.location.href = `mailto:pratikbugade555@gmail.com?subject=${subject}&body=${body}`;
    
    // Show success message
    alert('Opening your email client... If it doesn\'t open automatically, please email me at pratikbugade555@gmail.com');
  ...
  return (
    <section className="py-20 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2 className="font-bold mb-6 bg-gradient-to-r from-blue-400 to-green-400 bg-clip-text text-transparent" style={{ fontSize: 'clamp(2rem, 5.5vw, 3rem)' }}>
            Let's Connect
          </h2>
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                {[
                  { icon: Mail, label: "pratikbugade555@gmail.com", href: "mailto:pratikbugade555@gmail.com", color: "from-red-400 to-pink-400" },
                  { icon: Phone, label: "+91 9356910548", href: "tel:+919356910548", color: "from-green-400 to-blue-400" },
                  { icon: Github, label: "GitHub Profile", href: "https://github.com/pratikbugade01", color: "from-gray-400 to-gray-600" },
                  { icon: Linkedin, label: "LinkedIn Profile", href: "https://linkedin.com/in/pratik-bugade", color: "from-blue-400 to-blue-600" }
                ].map((social, index) => (
                  <motion.a
                    key={social.label}
                    href={social.href}
        ...
        >
          <p className="text-gray-500">
            © 2025 Pratik Bugade. Transforming data into intelligent AI/ML solutions.
          </p>
        </motion.div>
      </div>
    </section>
